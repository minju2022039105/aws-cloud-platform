...
![Trivy 이미지 스캔](docs/architecture/스크린샷/trivy_image_scan.png)

![Kubernetes /predict API 호출](docs/architecture/스크린샷/kub_predict_api.png)
...
## DevSecOps Pipeline Status: Completed (2026.05.28)
